 ...
 */
#define USE_CONTROLLER_FAN            //DJS
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN RAMPS_D9_PIN   // Set a custom pin for the controller fan   //DJS
 ...
 */
#define FAN_MIN_PWM 60    //DJS
#define FAN_MAX_PWM 255   //DJS
...
#define DEFAULT_STEPPER_DEACTIVE_TIME 0  //DJS
...
#else
  #define BLOCK_BUFFER_SIZE 16 // maximize block buffer   //DJS
#endif
